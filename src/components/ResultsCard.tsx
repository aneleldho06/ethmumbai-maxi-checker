  ...
  const downloadCard = async () => {
    ...
    try {
      const canvas = await html2canvas(shareCardRef.current, {
        ...
        logging: false,           // REQUIRED for prod
        imageTimeout: 15000,      // Allow avatar to load
        backgroundColor: null,    // ❗ VERY IMPORTANT
      });
